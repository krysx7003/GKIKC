...
4. Przy pomocy powyższych komend kompilują się WSZYSTKIE pliki .cpp
5. W przypadku Lab5 potrzeba żeby w katalogu z plikiem wykonywalnym znajdowały się plik tekstura(1 - 3).tga
6. W przypadku Lab6 potrzeba żeby w katalogu z plikiem wykonywalnym znajdował się katalog textures(z jego obecną zawartością)
7. W przypadku Lab7 końcowy efekt zawarty jest w pliku index.html
